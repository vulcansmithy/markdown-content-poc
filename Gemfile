...
group :development, :test do
  ...
  gem "rspec-rails", "5.0.2"   # https://github.com/rspec/rspec-rails
end
...
group :development do
  ...
  gem "awesome_print", "1.9.2"   # https://github.com/awesome-print/awesome_print
end
...
gem "versionist", "2.0.1"    # https://github.com/bploetz/versionist